...
// The calibration struct is declared in cal.cpp
extern calibration cal;
extern uint8_t yacp_product_firmware_version;
extern uint8_t yacp_product_id;
...
void setup() 
{
  ...
  yacp_product_firmware_version = 2;
  yacp_product_id = 0x1;  // YACP Demo
